    ...
    <g>
      ...
      <g id="bomb">
        <path
          id="motion-path"
          fill="none"
          d="m0,0l0,5a10,10 0 0 1 -20,0a18,18 0 0 0 -36,0l0,30"
        />
        <path
          stroke="null"
          fill="#E7402E"
        ...
        <rect
          x="120.36745"
          y="125.38426"
          transform="matrix(0.7071 0.7071 -0.7071 0.7071 101.112 -39.4959)"
          fill="#F4DD50"
          width="23.614"
          height="23.615"
          id="svg_11"
        ...
        <g id="spark">
          <path
            id="ember"
            transform="scale(2.1 2.1) translate(83 20)"
            stroke="#F3A37C"
            stroke-width="1.25"
        ...
        <text
          transform="rotate(180 105.781 146.791) matrix(1.14815 0 0 1.23535 89.2675 95.9221)"
          fill="#e7402e"
